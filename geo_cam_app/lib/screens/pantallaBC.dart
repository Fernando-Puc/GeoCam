...
import 'exploramunicipios/exploraBC/explora.dart';
import 'exploramunicipios/exploraBC/guardado.dart';
import 'exploramunicipios/exploraBC/historia.dart';

class PantallaBC extends StatefulWidget {
  const PantallaBC({super.key});

  @override
  State<PantallaBC> createState() => _PantallaBCState();
}

class _PantallaBCState extends State<PantallaBC> {
  ...
  Future<void> _loadMunicipalityData() async {
    final String response = await rootBundle.loadString(
      'lib/data/municipality/becal/becal.json',
    );
