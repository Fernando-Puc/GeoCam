...
class _NegociosState extends State<Negocios> {
  ...
  Future<void> _loadData() async {
    final String response = await rootBundle.loadString(
      'lib/data/municipality/dzitbalche/negocios.json',
    );
  ...
  Future<void> _toggleFavorito(int index, Map<String, dynamic> item) async {
    ...
    if (esFav) {
      await FavoritosDZService.eliminar(item['nombre'], 'Negocio');
      ...
      await FavoritosDZService.agregar({
        ...item,
        'tipo': 'Negocio',
      });
      ScaffoldMessenger.of(context).showSnackBar(
