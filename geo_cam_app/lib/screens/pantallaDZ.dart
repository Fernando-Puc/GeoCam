...
import 'exploramunicipios/exploraDZ/explora.dart';
import 'exploramunicipios/exploraDZ/guardado.dart';
import 'exploramunicipios/exploraDZ/historia.dart';

class PantallaDZ extends StatefulWidget {
  const PantallaDZ({super.key});

  @override
  State<PantallaDZ> createState() => _PantallaDZState();
}

class _PantallaDZState extends State<PantallaDZ> {
  ...
  Future<void> _loadMunicipalityData() async {
    final String response = await rootBundle.loadString(
      'lib/data/municipality/dzitbalche/dzitbalche.json',
    );
